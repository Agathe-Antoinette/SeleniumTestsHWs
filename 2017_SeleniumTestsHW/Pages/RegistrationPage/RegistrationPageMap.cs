...
namespace _2017_SeleniumTestsHW.Pages.RegistrationPage
{
    public partial class RegistrationPage : BasePage
    {
        ...
        public IWebElement ErrorMessagesForNames
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[1]/div[1]/div[2]/span");
            }
        }
        ...
        public IWebElement ErrorMessagesForHobby
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[3]/div/div[2]/span");
            }
        }
        ...
        public IWebElement ErrorMessagesForPhone
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[6]/div/div/span");
            }
        }
        ...
        public IWebElement ErrorMessagesForUsername
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[7]/div/div/span");
            }
        }
        ...
        public IWebElement ErrorMessagesForEmail
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[8]/div/div/span");
            }
        }
        ...
        public IWebElement ErrorMessagesForPassword
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[11]/div/div/span");
            }
        }
        ...
        public IWebElement ErrorMessagesForConfirmPassword
        {
            get
            {
                return getErrorMessage("//*[@id=\"pie_register\"]/li[12]/div/div/span");
            }
        }


        private IWebElement getErrorMessage(string XPath)
        {
